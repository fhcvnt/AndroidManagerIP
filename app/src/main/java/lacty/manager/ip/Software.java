...
import lacty.manager.ip.databinding.ActivitySoftwareBinding;
import lacty.manager.ip.databinding.ActivitySoftwareBinding;

public class Software extends AppCompatActivity {
    ActivitySoftwareBinding binding;
    ...
    public void clearTable() {
        int countrow = binding.tableSoftware.getChildCount();
        binding.tableSoftware.removeViews(1, countrow - 1);
    }
    ...
    public void sqlSearch(String chuoi) {
        ...
        try {
            ...
            String chuoitimkiem = chuoi.isEmpty() ? ""
                    : " AND (Software.SoThe LIKE '%" + chuoi + "%'" + " OR #DSIP.HoTen LIKE N'%" + chuoi
                    ...
                    + "%'" + " OR Software.Website LIKE N'%" + chuoi + "%'" + ip + ")";
            ...
            select = select + "\n"
                    + "SELECT Software.SoThe,#DSIP.HoTen,#DSIP.DonVi,#DSIP.IP,Software.Website,Software.NgayDeNghi,Software.NgayCapNhat,NguoiDung.TenNguoiDung FROM Software LEFT JOIN #DSIP ON Software.SoThe = #DSIP.SoThe LEFT JOIN NguoiDung ON Software.UserUpdate=NguoiDung.MaNguoiDung WHERE 1=1"
                    + chuoitimkiem + " ORDER BY Software.NgayCapNhat DESC";
            ...
            while (result.next()) {
                ...
                textview.setOnClickListener(onClickListenerData());
                textview2.setOnClickListener(onClickListenerData());
                textview3.setOnClickListener(onClickListenerData());
                textview4.setOnClickListener(onClickListenerData());
                textview5.setOnClickListener(onClickListenerData());
                textview6.setOnClickListener(onClickListenerData());
                textview7.setOnClickListener(onClickListenerData());
                textview8.setOnClickListener(onClickListenerData());
                textview9.setOnClickListener(onClickListenerData());

                binding.tableSoftware.addView(tr, new TableLayout.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, TableRow.LayoutParams.WRAP_CONTENT));
                stt++;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private View.OnClickListener onClickListenerData() {
